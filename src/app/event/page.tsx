...
const PageEvent=()=> {
    return(
        ...
        <div className={`${styles["event-des"]}`}>
         ...
         <img className={`${styles["event-image"]}`} src="https://inkythuatso.com/uploads/thumbnails/800/2022/03/anh-tay-cam-tra-sua-dep-24-23-13-45-09.jpg"/>
         </div>
         <div className={`${styles["text-div"]}`}>
         <p className={`${styles["title-author"]}`}>by LiemTroller  02/04/2024  Coffee types</p>
